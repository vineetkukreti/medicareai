...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 font-sans text-gray-900 dark:text-white transition-colors duration-300">
      <Navbar />
      ...
      <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-cyan-600 pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-screen-xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <Link to={isLoggedIn ? "/chatbot" : "/login"} className="inline-flex justify-center items-center py-3 px-6 text-base font-medium text-center text-blue-700 rounded-lg bg-white hover:bg-blue-50 focus:ring-4 focus:ring-blue-300 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1">
              💬 Chat with AI Doctor
              <svg className="w-4 h-4 ms-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
            </Link>
            <Link to={isLoggedIn ? "/symptom-checker" : "/login"} className="inline-flex justify-center items-center py-3 px-6 text-base font-medium text-center text-white rounded-lg border-2 border-white hover:bg-white hover:text-blue-700 focus:ring-4 focus:ring-blue-300 transition-all">
              🔍 Check Symptoms
            </Link>
          </div>
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-screen-xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Link to={isLoggedIn ? "/chatbot" : "/login"} className="group p-8 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl border border-blue-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            <Link to={isLoggedIn ? "/symptom-checker" : "/login"} className="group p-8 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            <Link to={isLoggedIn ? "/medications" : "/login"} className="group p-8 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl border border-green-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            <Link to={isLoggedIn ? "/health-records" : "/login"} className="group p-8 bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl border border-orange-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            {/* Feature 5 - Doctor Marketplace */}
            <Link to={isLoggedIn ? "/doctors" : "/login"} className="group p-8 bg-gradient-to-br from-indigo-50 to-blue-50 rounded-2xl border border-indigo-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Find Doctors</h3>
              <p className="text-gray-600 leading-relaxed">Browse and book video consultations with top-rated healthcare professionals. Available 24/7.</p>
            </Link>

            {/* Feature 6 - Health Insights */}
            <Link to={isLoggedIn ? "/health-insights" : "/login"} className="group p-8 bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl border border-teal-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link to={isLoggedIn ? "/chatbot" : "/login"} className="hover:text-blue-400 transition-colors">AI Chatbot</Link></li>
                <li><Link to={isLoggedIn ? "/symptom-checker" : "/login"} className="hover:text-blue-400 transition-colors">Symptom Checker</Link></li>
              </ul>
            </div>
            <div>
